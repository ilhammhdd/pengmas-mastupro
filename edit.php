...
<main>
    <div class="row">
        <div class="col s7 offset-s3">
            <div class="card-panel white" style="height:550px;">
                <form id="edit-form" method="POST" action="post_edit.php"
                      enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $_SESSION["editing-language"]["idLanguage"] ?>">
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="nama" type="text" class="validate" name="nama"
                                   value="<?php echo $_SESSION["editing-language"]["namaLanguage"]; ?>">
                            <label class="active" for="nama">Nama Bahasa</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                                <textarea id="keterangan" class="materialize-textarea"
                                          name="keterangan" maxlength="100000"><?php echo $_SESSION["editing-language"]["keteranganLanguage"]; ?></textarea>
                        ...
                        <div class="file-field input-field col s12">
                            ...
                            <div class="file-path-wrapper">
                                <input id="nama-file" name="nama_file" class="file-path validate" type="text"
                                       value="<?php echo $_SESSION["editing-language"]["namaFileLanguage"]; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
