                        ...
                        <div class="row">
                            <div class="section-content">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <script async defer
                                            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDMwo4vPSl8OosnsmVDqt031uO3n3ReRHI&callback=initMap">
                                    </script>

                                    <div class="row office">
                                        <div class="office-info">
                                            <img src="{{ asset('images/icons/location.png')}}" class="office-item">
                                            <p class="office-desc">Jalan Sukabirus No. 148, Desa Citereup, Kab.
                                                Bandung</p>
                                        </div>
                                        <div class="office-info">
